...
describe('testing payments', () => {
	test('should correctly get pulsar payment transaction1', async () => {
		...
		const receiversHex = [
			'bcf44ece21c798765175950b0b8a410b033bde28b68442f3b943bd6e2454935b',
			'e8064494aee3a4337014cebe9119aefa26ac58b4e72a64661ae3eaca6294d3dd',
		].join('');
	...
	test('should create vault esdt', async () => {
		...
		const { data: payment } = await Transactions.createVault(tokenId, amount, releaseTimestamp, name, address, chainId);
